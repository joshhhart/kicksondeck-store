...
tag: Explainers
read: 5 min read
excerpt: New to reps and drowning in jargon? Here's what 1:1, OG, batch, PK, and UA actually mean — in plain English, no gatekeeping.
description: A plain-English glossary of common rep sneaker terms — 1:1, OG, batch, PK (Primeknit), UA, and QC — so first-time buyers know exactly what they're looking at.
products: [zebra-yz-boost-350-v2, onyx-yz-foam-rnnr]
---
...
Want to see what a well-made 1:1 actually looks like? Browse the [350 V2 collection](/collection/350-v2/) or the [full rotation](/shop/) — every pair ships with QC photos and a buyer-protection window.

*Still deciding what to buy? The [quiz](/quiz/) sorts it in under a minute, or [vote on the next restock](/#vote) if nothing's calling your name yet.*

Curious about the buy/no-buy math beyond terminology? Read [Are Rep Sneakers Worth It?](/blog/are-rep-sneakers-worth-it/) or see exactly [how a rep compares to retail](/blog/rep-vs-real-yeezy-350-v2/) side by side.
